...
public class ThrowableScr : MonoBehaviour
{
    ...
    {
        GameObject explosionEffect = GlobalRefsScr.Instance.smokeGrenadeEffect;
    ...
    {
        // Visual Effect
        GameObject explosionEffect = GlobalRefsScr.Instance.grenadeExplosionEffect;
        Instantiate(explosionEffect, transform.position, transform.rotation);

        // Sound
        SManagerScr.Instance.ShootingChannel.PlayOneShot(SManagerScr.Instance.throwableClip);
